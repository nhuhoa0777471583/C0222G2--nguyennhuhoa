...
<table border="0" class="table table-bordered w-75 mx-auto" >
    <form method="post">
        ...
        <tr>
            <td>maxPeople</td>
            <td><input name="maxPeople" type="text"></td>
        </tr>
        <tr>
            <td>standard_room</td>
        ...
        <tr>
            ...
            <td><input name="descriptionOtherConvenience" type="text"></td>
        </tr>
        <tr>
            <td>pool_area</td>
            <td><input name="poolArea" type="text"></td>
        </tr>
        <tr>
            <td>number_of_float</td>
            <td><input name="numberofFloat" type="text"></td>
        </tr>
        <tr>
            <td>id_rent_type</td>
            <td>
