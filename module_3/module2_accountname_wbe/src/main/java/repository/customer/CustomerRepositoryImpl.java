...
public class CustomerRepositoryImpl implements ICustomerRepository {
    ...
    public static final String UPDATE_CUSTOMER = " update customer set name_customer = ?,birthday_customer=?,gender_customer = ?, id_card_customer = ?,phone = ?, email = ?,address =?,id_customer_type =? where id ? ";
    public static final String SELECT_CUSTOMER_BY_ID = " select name_customer,birthday_customer,gender_customer,id_card_customer,phone, " +
            " email,address,id_customer_type from customer where id = ? ";
